...
- MiniLM model and ONNX conversion: sentence-transformers/all-MiniLM-L6-v2 and Xenova/all-MiniLM-L6-v2, Apache-2.0. https://huggingface.co/Xenova/all-MiniLM-L6-v2
